...
<div class="container">
    ...
    <div class="col-md-10 mx-auto">
        ...
        <form class = "form-horizontal" method="POST" id="fin_sum_form">
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    Provisions : <input type = "number" style="border:0;" value="{{ number_format((float)$provisioned['Amount'], 2, '.', '') }}" name = "provisioned" id = "provisioned" readonly>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    <img src="http://www.bspd.in/app/fd.jpg" alt="FD image">
                </div>
            </div>
        </form>
    </div>        
