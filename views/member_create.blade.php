...
<div class="container">
    ...
    <form class = "form-horizontal" method="POST" id="member_creation_form">
        <div class="col-md-10 mx-auto">
            <div class="form-group row">
                <div class="col-sm-6">
                    <label class = "label-control">Last name(Surname) *</label>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <select class = "form-control" name = "gotram" id = "gotram" required>
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    <label class = "label-control">Entity id</label>
                    <input type = "text" class = "form-control" name = "entity_id" id = "entity_id" value="BHBNR001">
                </div>
            </div>
    ...
    <div>
        <span style="color:red;">Recently created members</span><br>
        @foreach ($members as $member)
        Phno: XXXXXX{{ $member->phno }}<br>{{ $member->name }}<br><br>
        @endforeach
    </div>
</div>
</body>
