        ...
        <div class="col-md-10 mx-auto">
            ...
            <div class="form-group row">
                <div class="col-sm-4">
                    ...
                    <input type = "text" class = "form-control" name = "first_name" id = "first_name" <?php if($_SESSION['id'] != 1116) echo "disabled"; ?>>
                </div>
                <div class="col-sm-4">
                    <label class = "label-control">Surname</label>
                    <input type = "text" class = "form-control" name = "last_name" id = "last_name" <?php if($_SESSION['id'] != 1116) echo "disabled"; ?>>
                </div>
                <div class="col-sm-4">
