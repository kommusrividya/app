                ...
                <div class="col-sm-6">
                    ...
                    <!--<option disabled selected>Choose one</option>-->
                        @foreach ($events as $event)
                            <option value = "{{ $event->id }}" data-date="{{ $event->date }}" data-voucher="{{ $event->voucher_num }}" data-entity_id="{{ $event->entity_id }}">{{ $event->entity_id }} {{ $event->id }} - {{ $event->description }}</option>   
                        @endforeach
                    </select>
                </div>
                <div class="col-sm-3">
