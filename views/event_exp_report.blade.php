            ...
            <div class="col-md-10 mx-auto">
                <div class="form-group row">
                    <div class="col-sm-5">
                        ...
                        <input type="text" class="form-control" name="event" id="exp_event" placeholder="<event id>" value="" required>
                    </div>
                    <div class="col-sm-7">
                        ...
                        <label class="radio-inline">
                            <input type="radio" name="report" value="payment_confirmation">Payment Confirmation
                        </label>
                        @endif
                        <label class="radio-inline">
