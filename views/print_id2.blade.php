                ...
                ?>
                    <td>
                        <table width=354 height=206 style="color:red; background-color:yellow;">
                            <tr>
                                <td><img src="https://www.bspd.in/app/kamakshiimage.jpg" width="100" height="100" class="css-class" alt="alt text"></td>
                                <td align="center"><span style="color:red; font-size:16px;"><b><img src="https://www.bspd.in/app/memberphotos/{{ $member->id }}.jpg" width="40" height="53" class="css-class" alt="alt text"><br>MemId: {{ $member->id }} </b></span></td>
                                <td align = "right"><img src="https://www.bspd.in/app/swamiimage.jpg" width="100" height="100" class="css-class" alt="alt text"></td></tr>
