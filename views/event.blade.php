        ...
        <div class="col-md-10 mx-auto">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    ...
                    <input type = "text" class = "form-control" name = "event_id" id = "event_id" required>
                </div>
                <div class="col-sm-3">
                    <label class = "label-control">Entity ID</label>
                    <input type = "text" class = "form-control" name = "entity_id" id = "entity_id" placeholder="" value="BHBNR001 " required>
                </div>
                ...
                <div class="col-sm-3">
                    ...
                    <select class = "form-control" name = "event_status" id = "event_status" @if($form_mode == "create") disabled @endif >
