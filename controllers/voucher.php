...
$event_id = explode(" ",$_GET['EVENT_ID']);
$entity_id = $event_id[0];
$EVENT_ID = $event_id[1];
$Start = $_GET['start'];
$End = $_GET['end'];
...
$sql = "SELECT * FROM bspdhyd_wp1.BSPD_View_Expense_Report where EVENT_ID = '$EVENT_ID' and DEShCode = '$entity_id' and Voucher_Num between $Start AND $End ORDER BY Voucher_Num;";
