...
$qpl="SELECT Voucher_Num,Name,Sub_Category,Amount_Details FROM bspdhyd_wp1.BSPD_View_Expense_Report where EVENT_ID='".$row['EVENT_ID']."' AND DEShCode = '".$row['DEShCode']."';";
$result=mysqli_query($link, $qpl);

$heading = "Voucher List ".$row['DEShCode']." ".$row['EVENT_ID'];
